<%-- 
    Document   : adminhome
    Created on : 10 DEC, 2022, 2:52:10 PM
    Author     : AMAN KUMARI
--%>
...
<html>
    <head>
        ...
        <!-- Site Metas -->
        <title>LU::ADMIN: HOME</title>
        <meta name="keywords" content="LU,LU LUCKNOW, best engineering college, lu lucknow,engineering in jankipuram extension, engineering in lucknow, engineering in chandauli,kamleshtech@gmail,kamlesh developer,kamleshkumarbind"/>
        <meta name="description" content=" LU::LUCKNOW : HOME ">
        <meta name="author" content="luchandauli.ac.in, getkamleshtech.in/"/>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="site_information">
                            <ul>
                                <li><a href="mailto:getamantech@gmail.com"><img src="images/mail_icon.png" alt="#" />ak.lu@gmail.com</a></li>
                                <li><a href="tel:amantech@gmail.com"><img src="images/phone_icon.png" alt="#" />+918112740805</a></li>
                    ...
                    <div class="row topleft">
                        <div class="col-sm-12 col-md-4 col-lg-4 col-md-col-xl-4 mb-md-0 mb-sm-4 mb-4 tm-site-header-col">
                            <div class="tm-site-header ">
                                <h1 class="mb-4"><span class="theme_color">LU</span>::ADMIN</h1>
                                <img src="images/pop_bg.jpg" class="img-fluid mb-4">
