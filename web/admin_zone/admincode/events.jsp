...
<%
    ...
    {
        out.print("<script>alert('Event is successfully logged & live now!!');window.location.href='../adminhome.jsp';</script>");
    }
    else
    {
        out.print("<script>alert('Sorry, Event is not added!');window.location.href='../adminhome.jsp';</script>");
    }
%>
