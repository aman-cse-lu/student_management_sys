<%-- 
    Document   : logout
    Created on : 10 DEC, 2022, 8:01:03 PM
    Author     : AMAN KUMARI
--%>
<%
...
<head>
    ...
    <!-- Site Metas -->
    <title>LU::ADMIN: LOGOUT</title>
    <meta name="keywords"
        content="LU,LU LUCKNOW, best engineering college, lu lucknow,engineering in dhanapur, engineering in lucknow, engineering in lucknow,amantech@gmail,aman developer,amankumarbind" />
...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98" onload="logout()" >
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="site_information">
                        <ul>
                            <li><a href="mailto:getamantech@gmail.com"><img src="images/mail_icon.png"
                                        alt="#" />amantech@gmail.com</a></li>
                            <li><a href="tel:getamantech@gmail.com"><img src="images/phone_icon.png"
    ...
    <div class="footer_bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="crp"><b>© Copyrights to LU-LUCKNOW&trade; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ::
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2022 design & developed by AMAN KUMARI<b></p>
                </div>
            </div>
        </div>
    </div>
