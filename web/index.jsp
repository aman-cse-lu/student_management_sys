...
<html>
    <head>
        ...
        <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
         ...
         <!-- Site Metas -->
        <title>LU::HOME</title>
        <meta name="keywords" content="LU,LU Lucknow, best engineering college,ak.lu@gmail,aman developer,amankumri"/>
        <meta name="description" content="LU::HOME ">
                    ...
                    <div class="row">
                        ...
                        <div class="site_information">
                            <ul>
                                ...
                                <li><a href="tel:ak.lu@gmail.com"><img src="images/phone_icon.png" alt="#" />+919876543210</a></li>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="slide_text white_fonts"><br>
                                            <h3><span class="text glower">Welcome</span><br><span class="txt">FACULTY OF ENGINEERING AND TECHNOLOGY, UNIVERSITY OF LUCKNOW</span><strong></strong> </h3>
                        ...
                        <div class="pogoSlider-slide" style="background-image:url(images/slide_img2.png);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="slide_text white_fonts"><br> 
                                            <h3><span class="text3d" id="shade">LU<br><br>LUCKNOW</span><br><strong></strong> </h3>
                                            <br><br><br><br><br><br><br><br> 
                    ...
                    <div class="col-md-6">
                        <div class="full paddding_left_15">
                            <div class="heading_main text_align_left">
                                <h2><span class="theme_color">Welcome To</span>  LU</h2>     
                            </div>
                        </div>
                        <div class="full paddding_left_15">
                            <p> Faculty of Engineering and Technology University of Lucknow, Lucknow has been established in year 2017 by the Government of Uttar Pradesh in the form of 
                                a non-affiliating, teaching and research University after reconstituting the Lucknow  Engineering College, 
                                lucknow which was established in 1962.. </p>
                        </div>
                        <div class="full paddding_left_15">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="full paddding_left_15">
                                <p> The idea of starting a University at Lucknow was first mooted by Raja Sir 
                                    Mohammad Ali Mohammad Khan, Khan Bahadur, K.C.I.E. of Mahmudabad, who
                                    contributed an article to the columns of "The Pioneer'' urging the foundation of a University at Lucknow.
                                    A little later Sir Harcourt Butler, K.C.S.I., K.C.I.E, was appointed Lieutenant-Governor of the United Provinces, 
                                    and his well-known interest in all matters under his jurisdiction, specially in matters educational, gave fresh life and vigour to
                                    the proposal. The first step to bring the University into being was taken when a General Committee of educationists and persons interested 
                                    in university education appointed for the purpose, met in conference at Government House, Lucknow, on November, 10, 1919. At this meeting Sir 
                                    Harcourt Butler, 
                                    who was in the chair, outlined the proposed scheme for the new university.</p>
                            </div>
                            <div class="full paddding_left_15">
                                <a class="main_bt" href="register.jsp">Enroll Now ! ></a>
                            </div>
