                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Alok Kumar Ray <br>Qualifications: B-Tech,M-Tech .He is working as a vice-principal since 8 years.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            <img class="img-responsive" src="images/fac1.jpg" alt="#" />
                            <div class="overlay"><a class="main_bt transparent" href="#">View</a></div>
                            <div class="blog_details">
                                <h3>H.O.D.</h3>
                                <p>Mr. Zeeshan Ali Siddiqui <br>Qualifications: B-Tech,M-Tech .He is working as a head of department since 8 years.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Mr.Himanshu Panday <br>Qualifications: B-Tech,M-Tech .He is working as a lecturar since 8 years.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Mr.Himanshu Shukla <br>Qualifications: B-Tech,M-Tech in CSE.He is working as a professor since 8 years.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            <img class="img-responsive" src="images/fac4.jpg" alt="#" />
                            <div class="overlay"><a class="main_bt transparent" href="#">View</a></div>
                            <div class="blog_details">
                                <h3>Computer Sci. Professor</h3>
                                <p>Mr.Jaswant Kumar<br>Qualifications: BSc,MSc in English .He is working as a lecturar since 8 years.</p>
                            </div>
                        </div>
                    </div>
