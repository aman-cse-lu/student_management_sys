...
<html>
    <head>
        ...
        <!-- Site Metas -->
        <title>LU::GALLERY</title>
        <meta name="keywords" content="LU,LU LUCKNOW, best engineering college,ak.lu@gmail,kamlesh developer,amankumari"/>
        <meta name="description" content="LU::GALLERY ">
