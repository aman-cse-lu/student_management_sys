            ...
            <div class="container ">
                    ...
                    <div class="col-md-12">
                        <div class="full">
                            <div class="heading_main text_align_center">
                                <h2><span class="theme_color">Contact Us </span></h2>    
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12 offset-lg-3">
                        <div class="full">
                            <form class="contact_form_inner" action="generalcode/contactcode.jsp">
                                <fieldset>
                                    <div class="field">
