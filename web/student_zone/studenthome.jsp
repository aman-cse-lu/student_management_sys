...
@media print {
	...
	.printme  {
        ...
        <meta name="keywords" content="LU,LU LUCKNOW, best engineering college, lu lucknow,engineering in jankipuram extension, engineering in lucknow, engineering in lucknow,amantech@gmail,kamlesh developer,kamleshkumarbind"/>
        <meta name="description" content=" LU::LUCKNOW : HOME ">
        <meta name="author" content="lulucknow.ac.in, getamantech.in/"/>
            ...
            <ul class="cd-hero-slider">
                ...
                <li class="selected">
                    <div class="heading">
                        ...
                        <span>Welcome to Faculty of Engineering and Technology University of Lucknow</span>
                    </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1 " style="text-align: center;">
                                                        <img   src="images/lulogoresult.png" alt="Image not available" style="margin-left: 50px; "> 
                                                    </div>
                                                    <div class="col-md-11" style="text-align: center;">
                                                        <h2>Faculty of Engineering and Technology University of Lucknow</h2>
                                                        <h5>Lucknow</h5> 
                                                    </div> </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="left-info">
                                                                <p>Complaint Box is always active 24*7 , you can register a complaint related to any thing you want & don't hesitate we are always with you !! 
                                                                    <br><br>
                                                                    <em>Good Luck! Write if you have any Issues..<br>to LU, Lucknow.</em>
                                                                </p>
